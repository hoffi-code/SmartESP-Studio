...
12. **Offen:** `DisplayInspector.vue` Element-Typ-Split abschließen — Graph + GraphLegend als eigene Komponente(n) + `useGraphTraces`, dabei die Legend-Font-Handler von `useDisplayFontControls` übernehmen (Composable ist dafür bereits vorbereitet).
